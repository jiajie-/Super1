...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.ic_schedule_focused,
				R.string.tab_schedule, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.drawable.indic_select);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		
		mIndicators[1] = createIndicator(R.drawable.ic_found_normal,
				R.string.tab_found, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		
		mIndicators[2] = createIndicator(R.drawable.ic_me_normal,
				R.string.tab_me, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.ic_schedule_normal);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.ic_found_normal);
		...
		case 0:
			...
			currIcon.setImageResource(R.drawable.ic_schedule_focused);
		...
		case 1:
			...
			currIcon.setImageResource(R.drawable.ic_found_focused);
